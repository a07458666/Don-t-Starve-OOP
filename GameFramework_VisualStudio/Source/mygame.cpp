...
namespace game_framework
{
	...
	void CgameMap::SetRun(bool Nrun){
		run = Nrun;
	}
	bool CgameMap::GetRun(){
		return run;
	}
	...
	{
		ground.SetTopLeft(x, y);
		ground.ShowBitmap();
	//	animationMap.SetTopLeft(x, y);
	//	animationMap.OnShow();
	}
	void CgameMap::SetDir(int nDir)
	{
		dir = nDir;
	}
...
{	
		...
		animationR.AddBitmap(IDB_Role2, RGB(255, 255, 255));
		animationR.AddBitmap(IDB_Role1, RGB(255, 255, 255));
		animationR.AddBitmap(IDB_Role3, RGB(255, 255, 255));
		animationR.AddBitmap(IDB_Role1, RGB(255, 255, 255));

		animationL.AddBitmap(IDB_Role5, RGB(255, 255, 255));
		animationL.AddBitmap(IDB_Role4, RGB(255, 255, 255));
		animationL.AddBitmap(IDB_Role6, RGB(255, 255, 255));		
		animationL.AddBitmap(IDB_Role4, RGB(255, 255, 255));

		animationD.AddBitmap(IDB_RoleD2, RGB(255, 255, 255));
		animationD.AddBitmap(IDB_Role0, RGB(255, 255, 255));
...
{ 
    ...
    */
    ...
    //
 //   bball.OnMove();
	if(gamemap.GetRun()==true)gamemap.OnMove();
}
